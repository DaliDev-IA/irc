...
class Server
{
	private:
		...
		void	handle_notice(int fd, const ParsedCommand &command);
		void	handle_who(int fd, const ParsedCommand &command);
		void	handle_quit(int fd, const ParsedCommand &command);
		void	send_unknown_command(int fd, const std::string &name);

		void	handle_mode(int fd, const ParsedCommand &command);
		void	handle_user_mode(int fd, const ParsedCommand &command);
